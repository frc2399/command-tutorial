 ...
 * @author Ed
 */
public class GrabWhiteTube extends CommandBase{

    public GrabWhiteTube() {
        requires(grabber);
    }

    /* Tells the grabber to go to the GRAB_WHITE position
     */ 
    protected void initialize() {
        grabber.setSetpoint(grabber.GRAB_WHITE);
    }
